...
export const metadata: Metadata = {
  ...
  description:
    'One command. Any stack. Choose a template, add addons, and ship production-ready Rust web servers, CLIs, and libraries.',
  keywords: [
    'rust templates',
    'rust starter',
    'create rust app',
  ...
  openGraph: {
    title: SITE_NAME,
    description: 'One command. Any stack. Compose templates and addons into production-ready Rust apps.',
    url: SITE_URL,
    siteName: SITE_NAME,
    images: [
      {
  ...
  twitter: {
    ...
    title: SITE_NAME,
    description: 'Discover Rust templates and extensions to accelerate your development workflow.',
