...
export const metadata = {
  title: 'Contributing | Create Rust App Documentation',
  description: 'Learn how to contribute templates and extensions to create-rust-app',
};
    ...
    <div className="container py-10">
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Contributing to create-rust-app</h1>
        ...
        <div className="space-y-8">
          <section id="contributing-overview" className="space-y-4">
            ...
            <p>The create-rust-app project welcomes contributions from the community. You can contribute by:</p>
...
graph TD
    ...
    F --> G["Merged!"]
          ...
          <section id="contributing-templates" className="space-y-4">
            ...
            <p>
              Templates are the foundation of create-rust-app. They provide the initial structure and configuration for
              ...
              <div className="space-y-2">
                ...
                <div className="rounded-md bg-muted p-4 mt-4">
                  <pre className="text-sm overflow-x-auto">
                    {`templates/
└── your-template-name/
    ├── src/              # Application source (binary + library targets)
  ...
  "templates": [
    // ... existing templates
    {
      ...
      "url": "https://github.com/Create-Rust-App/cra-templates/tree/main/templates/your-template-name",
      "type": "template-type",
      ...
      "labels": ["Label1", "Label2", "Label3"]
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    <strong>type</strong>: The type of template (e.g., &quot;web-server&quot;, &quot;cli-app&quot;,
                    &quot;library-starter&quot;, &quot;systems-app&quot;)
                  </li>
                  <li>
  ...
  },
  {
    ...
    "initial": "@/"
              ...
              <div className="space-y-2">
                ...
                <p>Once your template is ready, you can submit it for inclusion in the create-rust-app project:</p>
...
└── your-extension-name/
  ...
  "extensions": [
    // ... existing extensions
    {
      ...
      "url": "https://github.com/Create-Rust-App/cra-templates/tree/main/extensions/your-extension-name",
      ...
      "labels": ["Label1", "Label2", "Label3"]
              ...
              <div className="space-y-2">
                ...
                <ol className="list-decimal pl-6 space-y-4 mt-4">
                  ...
                  <li>
                    <strong>Define dependencies:</strong> Declare Rust crates your extension adds in a{' '}
                  ...
                  <li>
                    ...
                    <code>cargo</code> commands, include them in the extension README and any task runner config.
                  </li>
                  <li>
          ...
          <section id="best-practices" className="space-y-4 mt-8">
            ...
            <div className="grid gap-4 md:grid-cols-2 mt-4">
              ...
              <div className="rounded-lg border p-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>Include cargo fmt/clippy and cargo test configuration where applicable</li>
                  <li>Use explicit types and clippy-approved idioms</li>
                  <li>Add comprehensive doc comments where behavior is non-obvious</li>
                  <li>Follow Rust and framework best practices (axum, clap, tokio, serde)</li>
                </ul>
              </div>
              ...
              <div className="rounded-lg border p-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Document available <code>cargo</code> commands and Makefile targets
                  </li>
              ...
              <div className="rounded-lg border p-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>Test with stable and MSRV toolchains</li>
