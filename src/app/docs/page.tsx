...
export const metadata: Metadata = {
  title: 'Documentation | Create Rust App',
  description: 'Comprehensive documentation for create-rust-app',
    ...
    <div className="container py-10">
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-lg text-muted-foreground">Comprehensive guide to using create-rust-app</p>
        </div>

        <div className="space-y-8">
          <section id="introduction" className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight">Introduction to create-rust-app</h2>
            <p>
              <code>create-rust-app</code> is a powerful command-line tool designed to streamline the process of setting
              up modern Rust applications. It provides a collection of carefully crafted templates and extensions that
              help developers quickly bootstrap projects with best practices and optimal configurations.
            </p>
            ...
            <p>
              Using <code>create-rust-app</code> is straightforward. You can create a new project with a single command:
            </p>

            <Tabs defaultValue="cargo" className="w-full">
              <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="cargo">crates.io</TabsTrigger>
              ...
              <TabsContent value="scaffold" className="mt-2">
                <div className="rounded-md bg-muted p-4">
                  <pre className="text-sm">
                    <code>create-rust-app my-app --template web-server</code>
                  </pre>
                </div>
              </TabsContent>
            </Tabs>
            ...
            <p>Before using create-rust-app, ensure you have the following installed:</p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
              <li>
                Rust stable toolchain 1.75 or later (<code>rustc --version</code>)
              </li>
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  ...
                  <tr className="border-b">
                    ...
                    <td className="py-2 px-4">Generate project without fetching dependencies</td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-2 px-4">
                      <code>-t, --template &lt;template&gt;</code>
                    </td>
                    <td className="py-2 px-4">Specify a template from cra-templates</td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-2 px-4">
                  ...
                  <tr className="border-b">
                    ...
                    <td className="py-2 px-4">Bypass catalog cache (~/.cache/cra)</td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-2 px-4">
            ...
            <div className="space-y-4 mt-2">
              <div>
                ...
                <div className="rounded-md bg-muted p-4 mt-2">
                  <pre className="text-sm">
                    <code>create-rust-app my-app --interactive</code>
                  </pre>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="rounded-md bg-muted p-4 mt-2">
                  <pre className="text-sm">
                    <code>create-rust-app my-app --template web-server --addons rust-docker github-setup</code>
                  </pre>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="rounded-md bg-muted p-4 mt-2">
                  <pre className="text-sm">
                    <code>create-rust-app --list-templates</code>
                  </pre>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="rounded-md bg-muted p-4 mt-2">
                  <pre className="text-sm">
                    <code>create-rust-app --list-addons</code>
                  </pre>
                </div>
              </div>
          ...
          <section className="space-y-4">
            ...
            <p>create-rust-app offers a variety of templates for different types of applications:</p>

            <div className="rounded-lg border bg-muted/40 p-6 flex items-center justify-between">
              <div>
                <p className="font-semibold">Wave-1 Rust templates</p>
                <p className="text-sm text-muted-foreground mt-1">
                  Web servers, CLIs, libraries, and systems apps from cra-templates.
                </p>
              </div>
              <Button asChild>
                <Link href="/templates">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>crates.io, GitHub Releases, Homebrew, and Docker install options</CardDescription>
                </CardHeader>
                <CardContent>
