...
export const metadata: Metadata = {
  title: 'Extensions | Create Rust App Documentation',
  description:
    'Learn about extensions and how to add Docker, databases, rust-toolchain CI, fmt/clippy hooks, and Dev Containers to your Rust project.',
...
const categories = [
  {
    name: 'Containers',
    description: 'Docker images, Compose stacks, and Dev Containers for Rust toolchains.',
    icon: <Container className="h-5 w-5 text-primary" />,
    examples: ['rust-docker', 'development-container'],
  },
  {
    name: 'Database',
    description: 'SQLite and Postgres overlays with env samples and compose services.',
    icon: <Database className="h-5 w-5 text-primary" />,
    examples: ['sqlx-sqlite', 'sqlx-postgres'],
  },
  {
    name: 'CI & GitHub',
    description: 'GitHub Actions workflows using dtolnay/rust-toolchain.',
    icon: <Cloud className="h-5 w-5 text-primary" />,
    examples: ['github-setup'],
  },
  {
    name: 'Tooling',
    description: 'Format, clippy, and local quality gates for Rust projects.',
    icon: <Wrench className="h-5 w-5 text-primary" />,
    examples: ['rust-fmt-clippy'],
  },
  {
    name: 'Developer Experience',
    description: 'Remote development environments with the Rust toolchain.',
  ...
  },
  {
    ...
    examples: ['rust-docker', 'sqlx-postgres', 'github-setup'],
  },
  {
    name: 'Quality',
    description: 'Hooks and Makefile targets for fmt/clippy before commit.',
      ...
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-lg text-muted-foreground">
            ...
            to layer in Docker packaging, databases, rust-toolchain CI, fmt/clippy hooks, and more.
          </p>
        </div>
        ...
        <div className="space-y-8">
          <section id="what-is-an-extension" className="space-y-4">
            ...
            <p>
              ...
              metadata) onto a scaffolded Rust project. Extensions are composable: you can apply multiple compatible
            ...
            <div className="rounded-md bg-muted p-4">
              <pre className="text-sm overflow-x-auto">
                <code>
                  create-rust-app my-app --template web-server --addons rust-docker github-setup rust-fmt-clippy
                </code>
              </pre>
            </div>
          </section>
          ...
          <section id="how-extensions-work" className="space-y-4">
            ...
            <ol className="list-decimal pl-6 space-y-3 mt-2">
              ...
              <li>
                <strong>Cargo.toml / docs</strong> — extensions may add Makefile targets, CI workflows, compose files,
                or <code>docs/</code> notes without replacing your app entrypoints.
              </li>
              <li>
