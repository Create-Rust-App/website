...
export const metadata: Metadata = {
  title: 'Templates | Create Rust App Documentation',
  description: 'Learn about the available project templates and how to use them with create-rust-app.',
...
const typeIcons: Record<string, React.ReactNode> = {
  ...
  'ndarray-starter': <Zap className="h-5 w-5 text-primary" />,
  'burn-starter': <Globe className="h-5 w-5 text-primary" />,
  'tokio-starter': <Layers className="h-5 w-5 text-primary" />,
};
      ...
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-lg text-muted-foreground">
            Project templates are the starting point for every <code>create-rust-app</code> project. Each template is a
            complete, production-ready <code>Cargo.toml</code> skeleton for a specific Rust stack.
          </p>
        </div>
        ...
        <div className="space-y-8">
          <section id="what-is-a-template" className="space-y-4">
            ...
            <p>
              A template provides the initial directory structure, <code>Cargo.toml</code>, configuration files, and
              tooling for a new project. When you run <code>create-rust-app</code>, you pick a template and optionally
              layer{' '}
              <Link href="/docs/extensions" className="text-primary hover:underline">
                extensions
              </Link>{' '}
              on top to add Docker, CI, database overlays, or fmt/clippy hooks.
            </p>
            ...
            <p>
              ...
              <code>systems-app</code>. Domain starters <code>ndarray-starter</code> (scientific),{' '}
              <code>burn-starter</code> (ML/tensors), and <code>tokio-starter</code> (async) ship with real crates.io
              dependencies. Compose burn+ndarray via the <code>burn-ndarray-bridge</code> addon rather than a combined
              base template.
            </p>
          </section>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="rounded-md bg-muted p-4">
                  <pre className="text-sm overflow-x-auto">
                    <code>
                      create-rust-app my-api --template web-server --addons rust-docker github-setup --no-interactive
                    </code>
                  </pre>
                </div>
              </div>
          ...
          <section id="template-structure" className="space-y-4">
            ...
            <p>
              Every template lives under <code>templates/</code> in the cra-templates repository:
            </p>
            <div className="rounded-md bg-muted p-4">
              <pre className="text-sm overflow-x-auto">
                {`templates/
