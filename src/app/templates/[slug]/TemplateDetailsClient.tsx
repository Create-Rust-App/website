              ...
              <Tabs defaultValue="overview" className="fade-in-up-delay-2">
                ...
                <TabsContent value="overview" className="space-y-4">
                  <div className="prose prose-gray dark:prose-invert max-w-none">
                    ...
                    <ul>
                      <li>Pre-configured Rust project with Cargo.toml</li>
                      <li>cargo fmt, cargo clippy, and cargo test out of the box</li>
                ...
                <TabsContent value="usage" className="space-y-4">
                  <div className="prose prose-gray dark:prose-invert max-w-none">
                    ...
                    <div className="bg-muted rounded-md p-4 font-mono text-sm overflow-x-auto shimmer">
                      <p>create-rust-app --template {template.slug}</p>
                    </div>
                    <h3 className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-cyan-500">
                      With Extensions
                    </h3>
                    ...
                    <div className="bg-muted rounded-md p-4 font-mono text-sm overflow-x-auto shimmer">
                      <p>
                        create-rust-app --template {template.slug} --addons{' '}
                ...
                <TabsContent value="features" className="space-y-4">
                  <div className="prose prose-gray dark:prose-invert max-w-none">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 not-prose mt-4">
                      {[
                        {
                          title: 'Cargo.toml + crates.io',
                          desc: 'Dependencies declared in Cargo.toml and fetched with cargo fetch.',
                        },
                        {
                          title: 'Quality tooling',
                          desc: 'cargo fmt, cargo clippy, and optional rust-fmt-clippy hooks for local quality gates.',
                        },
                        {
                          title: 'Testing setup',
                          desc: 'cargo test harness and integration smoke tests ready to extend.',
                        },
                        {
                          title: 'Composable extensions',
                          desc: 'Docker, rust-toolchain CI, databases, and Dev Containers via --addons.',
                        },
                      ].map((f) => (
              ...
              <Card className="backdrop-blur-sm bg-card/50 border-primary/10 gradient-border shimmer">
                ...
                <CardContent>
                  <div className="bg-muted rounded-md p-4 font-mono text-sm overflow-x-auto mb-4">
                    <p className="text-green-500">$ create-rust-app \</p>
                ...
                <CardFooter className="flex flex-col items-start gap-4">
                  <CopyButton
                    ...
                    command={`create-rust-app --template ${template.slug}`}
                  />
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Start creating your Rust app with this template
              </p>
            </div>
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              <Button
                ...
                onClick={() => {
                  navigator.clipboard?.writeText?.(`create-rust-app --template ${template.slug}`);
                }}
              >
                Get Started
              </Button>
