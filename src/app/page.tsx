...
const PRIMARY_COMMAND = 'create-rust-app my-app';
    ...
    <div className="flex min-h-screen flex-col">
      <div className="flex-1">
        ...
        <HeroSection
          ...
          description="Choose a template, add extensions, and ship a production-ready Rust web server, CLI, or library from a cozy developer workbench."
          actions={
            <>
              <CopyButton
              ...
              <div className="flex items-center justify-center">
                <Card className="w-full backdrop-blur-sm bg-card/50 border-primary/10 gradient-border-subtle">
                  <CardHeader>
                    ...
                    <CardDescription>Use the CLI to generate your Rust app</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    <div className="bg-muted rounded-md p-4 font-mono text-sm overflow-x-auto">
                      <p className="text-violet-700 dark:text-violet-300">$ create-rust-app my-app \</p>
                      <p className="pl-4">--template web-server \</p>
                      <p className="pl-4">--addons rust-docker github-setup</p>
                    </div>
                    <CopyButton
                      command="create-rust-app my-app --template web-server --addons rust-docker github-setup --no-interactive"
                      variant="outline"
                      className="w-full"
                    />
                  </CardContent>
                  <CardFooter>
                    <p className="text-sm text-muted-foreground">
                      Generates an axum server with Docker packaging, rust-toolchain CI, and Rust-native fmt/clippy
                      hooks.
                    </p>
                  </CardFooter>
                </Card>
