export const SITE_URL = 'https://create-awesome-rust-app.vercel.app';
export const SITE_NAME = 'Create Rust App';
export const SITE_DESCRIPTION =
  'Discover production-ready templates and extensions to jumpstart your next Rust project. Combine starters and add-ons to build faster with Cargo.';
