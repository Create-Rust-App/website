...
const highlights = [
  { icon: MessagesSquare, label: 'Chat across Node, Python, V, and Rust' },
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-lg text-slate-300 max-w-lg">
                Join Create Awesome for live chat, good first issues, and collaboration across the Node, Python, V, and
                Rust ecosystems.
              </p>
            </div>
