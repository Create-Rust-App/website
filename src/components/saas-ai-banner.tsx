...
const features = [
  { icon: Server, label: 'axum / actix-web HTTP server' },
  { icon: Terminal, label: 'CLI with flag parsing' },
  { icon: Package, label: 'Cargo.toml + crates.io crates' },
  { icon: Gauge, label: 'cargo fmt / clippy / test' },
  { icon: Github, label: 'rust-toolchain GitHub Actions' },
  { icon: Container, label: 'Docker + Compose overlays' },
  { icon: Shield, label: 'Pre-commit fmt/clippy hooks' },
  { icon: Layers, label: 'Composable cra-templates' },
  { icon: Workflow, label: 'Cache at ~/.cache/cra' },
  { icon: BookOpen, label: 'ndarray / burn / tokio roadmap' },
];
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-lg text-slate-300 max-w-lg">
                Production-oriented axum scaffold with crates.io deps, CI via rust-toolchain, and composable extensions.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              ...
              <Button
                ...
                asChild
              >
                <a href="https://github.com/Create-Rust-App/cra-templates" target="_blank" rel="noopener noreferrer">
                  View cra-templates →
                </a>
              </Button>
            </div>
          ...
          <div className="flex items-center justify-center">
            <div className="w-full rounded-xl border border-violet-400/20 bg-slate-900/80 shadow-2xl shadow-violet-900/30 backdrop-blur-sm overflow-hidden">
              ...
              <div className="p-4 sm:p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                <p className="text-green-400">$ create-rust-app my-api \</p>
                <p className="text-slate-300 pl-4">--template web-server \</p>
                <p className="text-slate-300 pl-4">--addons rust-docker github-setup</p>
                <p className="mt-4 text-slate-500"># ✅ axum server scaffold ready</p>
                <p className="text-slate-500"># ✅ cargo fmt/clippy hooks configured</p>
                <p className="text-slate-500"># ✅ rust-toolchain CI workflow included</p>
