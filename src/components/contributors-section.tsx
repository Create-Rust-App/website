          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button
                ...
                asChild
              >
                <Link href="https://github.com/Create-Rust-App/create-rust-app/blob/main/CONTRIBUTING.md">
                  Contributing guide
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" asChild>
                <Link href="https://github.com/Create-Rust-App">
