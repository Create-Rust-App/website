  ...
  return (
    ...
    >
      <div className="container flex h-16 items-center gap-2 sm:gap-4">
        <Link href="/" className="flex min-w-0 items-center gap-2.5 group" aria-label="Create Rust App home">
          <svg
            width="36"
            height="36"
            viewBox="0 0 36 36"
        ...
        <div className="ml-auto flex items-center gap-0.5 sm:gap-1 md:gap-2 lg:ml-0">
          ...
          <ThemeToggle />
          <Link href="https://github.com/Create-Rust-App/create-rust-app" target="_blank" aria-label="crates.io crate">
          ...
          <Link href="https://github.com/Create-Rust-App" target="_blank" aria-label="GitHub">
