...
const STACKS = [
  {
    label: 'Web server',
    lines: [
      { prefix: '$', text: ' create-rust-app my-api', color: 'text-foreground' },
      { prefix: '✔', text: ' Template   web-server', color: 'text-green-400' },
      { prefix: '✔', text: ' Extensions github-setup · rust-docker', color: 'text-green-400' },
      { prefix: '✔', text: ' Running cargo fetch...', color: 'text-muted-foreground' },
      { prefix: '✔', text: ' Ready. cd my-api && cargo run', color: 'text-primary' },
    ],
  },
  {
    label: 'CLI tool',
    lines: [
      { prefix: '$', text: ' create-rust-app my-cli', color: 'text-foreground' },
      { prefix: '✔', text: ' Template   cli-app', color: 'text-green-400' },
      { prefix: '✔', text: ' Extensions github-setup · rust-fmt-clippy', color: 'text-green-400' },
      { prefix: '✔', text: ' Running cargo fetch...', color: 'text-muted-foreground' },
      { prefix: '✔', text: ' Ready. cd my-cli && cargo run -- --help', color: 'text-primary' },
    ],
  },
  {
    label: 'Library crate',
    lines: [
      { prefix: '$', text: ' create-rust-app my-lib', color: 'text-foreground' },
      { prefix: '✔', text: ' Template   library-starter', color: 'text-green-400' },
      { prefix: '✔', text: ' Extensions github-setup', color: 'text-green-400' },
      { prefix: '✔', text: ' Running cargo fetch...', color: 'text-muted-foreground' },
      { prefix: '✔', text: ' Ready. cd my-lib && cargo test', color: 'text-primary' },
    ],
  },
];
