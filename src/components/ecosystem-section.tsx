...
const ECOSYSTEM: EcosystemEntry[] = [
  {
    ...
    slug: 'create-rust-app',
    description:
      'Composition-first scaffolding for Rust — web servers, CLIs, libraries, and systems apps with cargo fmt/clippy and crates.io.',
    status: 'production',
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-3 mb-10">
          ...
          <p className="max-w-2xl text-muted-foreground md:text-lg">
            The composition-first scaffolding approach spans ecosystems. Start with Rust today — explore{' '}
            <a
