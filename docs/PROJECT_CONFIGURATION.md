...
The application is the official [Create Rust App](https://github.com/Create-Rust-App/create-rust-app) marketing site, built with Next.js 15, TypeScript, and Tailwind CSS v3.
